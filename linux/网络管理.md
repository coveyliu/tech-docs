...
![image-20220404231134410](https://blog-bt.oss-cn-beijing.aliyuncs.com/1/20220404231134.png)
...
![image-20220404231342055](https://blog-bt.oss-cn-beijing.aliyuncs.com/1/20220404231342.png)
...
- 比如，检查百度的 80 端口
  ...
  ![image-20220404232126953](https://blog-bt.oss-cn-beijing.aliyuncs.com/1/20220404232127.png)
...
![image-20220405111751066](https://blog-bt.oss-cn-beijing.aliyuncs.com/1/20220405111751.png)
...
- 网络服务读取哪些配置文件？
  - 网卡配置文件
    ...
    - 需要关注这几个配置：
      ...
      - ONBOOT
    - 看下网卡配置文件 
    - <img width = '150' height ='150' src="https://blog-bt.oss-cn-beijing.aliyuncs.com/1/20220405113818.png" alt="image-20220405113818389"  />
- 配置完网卡后，怎么生效？
...
1. 网卡配置文件（ifcfg-网卡名），比如：ifcfg-eth0
2. 主机名配置文件，/etc/hosts
